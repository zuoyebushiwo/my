 ...
 * 这个是最基本，也是最经典的排列
 * 
 * 算法思想：可以输出1加上23的全排列，2加13的全排列，3加上12的全排列， 运用递归求比如23的全排列..依次递归下去；比如现在要2开头求全排，
 * 首先要交换1，2的位置，让a[0]变为2，在用递归求13的所有全排列， 前面加个2就是2开头的所有全排列了，最后运用回溯再把1，2调换回来。
 *
 */
public class PaiLie01My {

	public static void main(String[] args) {
		PaiLie01My robot = new PaiLie01My();
		int[] a = { 1, 2, 3 };
